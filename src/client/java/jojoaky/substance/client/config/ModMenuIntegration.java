...
public class ModMenuIntegration implements ModMenuApi {
    ...
    private ConfigCategory buildGameplayCategory() {
        return ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                        .name(Component.translatable("text.config.substance.group.mobEquipment"))
                        .description(OptionDescription.of(Component.translatable("text.config.substance.group.mobEquipment.desc")))

                        .option(Option.<Float>createBuilder()
                                .name(Component.translatable("text.config.substance.option.mobCigaretteSpawnChance"))
                                .description(OptionDescription.of(Component.translatable("text.config.substance.option.mobCigaretteSpawnChance.desc")))
                                .binding(0.03f, () -> Config.get().mobCigaretteSpawnChance, val -> Config.get().mobCigaretteSpawnChance = val)
                                .controller(opt -> FloatSliderControllerBuilder.create(opt)
                                        .range(0.0f, 1.0f).step(0.005f)
                                        .formatValue(val -> Component.literal(String.format("%.1f%%", val * 100))))
                                .build())

                        .option(Option.<Float>createBuilder()
                                .name(Component.translatable("text.config.substance.option.mobHerbalRollSpawnChance"))
                                .description(OptionDescription.of(Component.translatable("text.config.substance.option.mobHerbalRollSpawnChance.desc")))
                                .binding(0.03f, () -> Config.get().mobHerbalRollSpawnChance, val -> Config.get().mobHerbalRollSpawnChance = val)
                                .controller(opt -> FloatSliderControllerBuilder.create(opt)
                                        .range(0.0f, 1.0f).step(0.005f)
                                        .formatValue(val -> Component.literal(String.format("%.1f%%", val * 100))))
                                .build())
                        ...
                        .option(Option.<Float>createBuilder()
                                .name(Component.translatable("text.config.substance.option.mobThickHerbalRollSpawnChance"))
                                .description(OptionDescription.of(Component.translatable("text.config.substance.option.mobThickHerbalRollSpawnChance.desc")))
                                .binding(0.005f, () -> Config.get().mobThickHerbalRollSpawnChance, val -> Config.get().mobThickHerbalRollSpawnChance = val)
                                .controller(opt -> FloatSliderControllerBuilder.create(opt)
                                        .range(0.0f, 1.0f).step(0.005f)
                                        .formatValue(val -> Component.literal(String.format("%.1f%%", val * 100))))
                                .build())
                        ...
                        .option(Option.<Integer>createBuilder()
                                .name(Component.translatable("text.config.substance.option.mobUseAttemptInterval"))
                                .description(OptionDescription.of(Component.translatable("text.config.substance.option.mobUseAttemptInterval.desc")))
                                .binding(140, () -> Config.get().mobUseAttemptInterval, val -> Config.get().mobUseAttemptInterval = val)
                                .controller(opt -> IntegerFieldControllerBuilder.create(opt).min(1))
                                .build())
                        .build())
