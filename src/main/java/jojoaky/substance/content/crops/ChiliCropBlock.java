...
public class ChiliCropBlock extends BushBlock implements BonemealableBlock, CuttableCrop {
    ...
    private static final ResourceKey<LootTable> HARVEST_LOOT_TABLE = ResourceKey.create(
            Registries.LOOT_TABLE,
            ResourceLocation.fromNamespaceAndPath("substance", "gameplay/chili_cut")
    );
    ...
    protected ItemInteractionResult useItemOn(
        ...
        harvest(state, level, pos, player, stack);
    ...
    protected @NotNull InteractionResult useWithoutItem(
        ...
        harvest(state, level, pos, player, ItemStack.EMPTY);
        return InteractionResult.sidedSuccess(level.isClientSide);
    }

    private void harvest(BlockState state, Level level, BlockPos pos, Player player, ItemStack tool) {
        if (level instanceof ServerLevel serverLevel) {
            List<ItemStack> drops = cut(state, serverLevel, pos, tool);
