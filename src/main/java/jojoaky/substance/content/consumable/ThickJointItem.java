...
public class ThickJointItem extends JointItem {
    ...
    public void onUseTick(Level level, LivingEntity entity, ItemStack stack, int i) {
        ...
        SubstanceEffectHelper.applyEffectBase(entity, ModEffects.RELAXATION.get(), 160, 0);
        SubstanceEffectHelper.applyEffectBase(entity, ModEffects.WARP.get(), 160, 0);
    }
    ...
    protected void onStopConsuming(ItemStack stack, Level level, LivingEntity entity, int useDuration) {
        ...
        SubstanceEffectHelper.applyStackingEffect(entity, ModEffects.RELAXATION.get(), useDuration * 12, 800, 3);
        SubstanceEffectHelper.applyStackingEffect(entity, ModEffects.WARP.get(), useDuration * 12, 600, 4);
        SubstanceEffectHelper.applyStackingEffect(entity, ModEffects.HAZE.get(), useDuration * 8, 600, 1);
    }
}
