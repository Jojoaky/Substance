...
public class JointItem extends ConsumableItem {
    ...
    protected void onStopConsuming(ItemStack stack, Level level, LivingEntity entity, int useDuration) {
        ...
        SubstanceEffectHelper.applyStackingEffect(entity, ModEffects.RELAXATION.get(), useDuration * 10, 800, 2);
        SubstanceEffectHelper.applyStackingEffect(entity, ModEffects.WARP.get(), useDuration * 10, 600, 3);
    }
}
